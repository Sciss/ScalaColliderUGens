...
/** A low frequency oscillator UGen for modelling vibrato. It produces a modulating
  ...
  * }}}
  */
object Vibrato extends ProductType[Vibrato] {
  def kr: Vibrato = kr()
  ...
  final val typeId = 236
  
  def read(in: RefMapIn, key: String, arity: Int): Vibrato = {
    require (arity == 9)
...
/** A non-band-limited pulse oscillator UGen. Outputs a high value of one and a low
  ...
  */
object LFPulse extends ProductType[LFPulse] {
  def kr: LFPulse = kr()
...
/** A sawtooth oscillator UGen. The oscillator is creating an aliased sawtooth,
  ...
  */
object LFSaw extends ProductType[LFSaw] {
  def kr: LFSaw = kr()
  ...
  final val typeId = 238
  
  def read(in: RefMapIn, key: String, arity: Int): LFSaw = {
    require (arity == 3)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _iphase = in.readGE()
...
/** A sine-like oscillator UGen with a shape made of two parabolas. It has audible
  ...
  */
object LFPar extends ProductType[LFPar] {
  def kr: LFPar = kr()
...
/** A sine-like oscillator UGen with a shape made of two cubic pieces. It is
  ...
  */
object LFCub extends ProductType[LFCub] {
  def kr: LFCub = kr()
...
/** A triangle oscillator UGen designed for low frequency control signals (being
  ...
  * }}}
  */
object LFTri extends ProductType[LFTri] {
  def kr: LFTri = kr()
...
/** A non-band-limited gaussian function oscillator UGen. Output ranges from
  ...
  * }}}
  */
object LFGauss extends ProductType[LFGauss] {
  def kr: LFGauss = kr()
...
/** A non-band-limited generator UGen for single sample impulses.
  ...
  */
object Impulse extends ProductType[Impulse] {
  def kr: Impulse = kr()
  ...
  final val typeId = 243
  
  def read(in: RefMapIn, key: String, arity: Int): Impulse = {
    require (arity == 3)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _phase  = in.readGE()
...
/** A sawtooth-triangle oscillator UGen with variable duty. A `width` of zero
  ...
  */
object VarSaw extends ProductType[VarSaw] {
  def kr: VarSaw = kr()
  ...
  final val typeId = 244
  
  def read(in: RefMapIn, key: String, arity: Int): VarSaw = {
    require (arity == 4)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _iphase = in.readGE()
...
/** A sawtooth oscillator UGen that is hard sync'ed to a fundamental pitch. That
  ...
  * @see [[de.sciss.synth.ugen.LFSaw$ LFSaw]]
  */
object SyncSaw extends ProductType[SyncSaw] {
  def kr: SyncSaw = kr()
...
/** A UGen that creates a constant signal at a given calculation rate.
  ...
  */
object DC extends ProductType[DC] {
...
/** A line generator UGen that moves from a start value to the end value in a given
  ...
  */
object Line extends ProductType[Line] {
  def kr: Line = kr()
  ...
  final val typeId = 251
  
  def read(in: RefMapIn, key: String, arity: Int): Line = {
    require (arity == 5)
    val _rate       = in.readRate()
...
/** An exponential curve generator UGen that moves from a start value to the end
  ...
  */
object XLine extends ProductType[XLine] {
  def kr: XLine = kr()
...
/** A UGen that constrains a signal to a given range, by "wrapping" values outside
  ...
  */
object Wrap extends ProductType[Wrap] {
...
/** A UGen that constrains a signal to a given range, by "folding" values outside
  ...
  * @see [[de.sciss.synth.ugen.Clip$ Clip]]
  */
object Fold extends ProductType[Fold] {
  /** @param in               input signal to constrain
...
/** A UGen that constrains a signal to a given range, by limiting values outside
  ...
  * @see [[de.sciss.synth.ugen.Fold$ Fold]]
  */
object Clip extends ProductType[Clip] {
  /** @param in               input signal to constrain
  ...
  final val typeId = 255
  
  def read(in: RefMapIn, key: String, arity: Int): Clip = {
    require (arity == 4)
    val _rate = in.readRate()
    val _in   = in.readGE()
    val _lo   = in.readGE()
...
/** A UGen that produces a psychoacoustic amplitude compensation factor for a given
  ...
  */
object AmpComp extends ProductType[AmpComp] {
  def ir: AmpComp = ir()
...
/** A UGen that produces a psychoacoustic amplitude compensation factor for a given
  ...
  */
object AmpCompA extends ProductType[AmpCompA] {
  def ir: AmpCompA = ir()
...
/** A UGen that tests if a signal is within a given range. If `in >= lo` and
  ...
  */
object InRange extends ProductType[InRange] {
...
/** A UGen that tests if two signals lie both within a given ranges. The two input
  ...
  * @see [[de.sciss.synth.ugen.Clip$ Clip]]
  */
object InRect extends ProductType[InRect] {
  ...
  final val typeId = 260
  
  def read(in: RefMapIn, key: String, arity: Int): InRect = {
    require (arity == 7)
    val _rate   = in.readRate()
    val _x      = in.readGE()
    val _y      = in.readGE()
...
/** A UGen which maps a linear range to an exponential range. The equivalent
  ...
  * @see [[de.sciss.synth.ugen.Clip$ Clip]]
  */
object LinExp extends ProductType[LinExp] {
  ...
  final val typeId = 261
  
  def read(in: RefMapIn, key: String, arity: Int): LinExp = {
    require (arity == 6)
...
/** An envelope generator UGen. It uses a break point description in its `envelope`
  ...
  */
object EnvGen extends ProductType[EnvGen] {
  ...
  final val typeId = 262
  
  def read(in: RefMapIn, key: String, arity: Int): EnvGen = {
    require (arity == 7)
    val _rate       = in.readRate()
...
/** A linear ASR-type envelope generator UGen.
  ...
  * @see [[de.sciss.synth.ugen.EnvGen$ EnvGen]]
  */
object Linen extends ProductType[Linen] {
  def kr: Linen = kr()
...
/** Envelope generator UGen with random access index pointer into the break-point
  ...
  * @see [[de.sciss.synth.ugen.EnvGen$ EnvGen]]
  */
object IEnvGen extends ProductType[IEnvGen] {
  /** @param envelope         the description of the envelope break-points. Typically
