...
object Vibrato extends ProductReader[Vibrato] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Vibrato = {
    require (arity == 9)
...
object LFPulse extends ProductReader[LFPulse] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): LFPulse = {
    require (arity == 4)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _iphase = in.readGE()
...
object LFSaw extends ProductReader[LFSaw] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): LFSaw = {
    require (arity == 3)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _iphase = in.readGE()
...
object LFPar extends ProductReader[LFPar] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): LFPar = {
    require (arity == 3)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _iphase = in.readGE()
...
object LFCub extends ProductReader[LFCub] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): LFCub = {
    require (arity == 3)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _iphase = in.readGE()
...
object LFTri extends ProductReader[LFTri] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): LFTri = {
    require (arity == 3)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _iphase = in.readGE()
...
object LFGauss extends ProductReader[LFGauss] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): LFGauss = {
    require (arity == 6)
    val _rate       = in.readRate()
    val _dur        = in.readGE()
    val _width      = in.readGE()
...
object Impulse extends ProductReader[Impulse] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Impulse = {
    require (arity == 3)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _phase  = in.readGE()
...
object VarSaw extends ProductReader[VarSaw] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): VarSaw = {
    require (arity == 4)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _iphase = in.readGE()
...
object SyncSaw extends ProductReader[SyncSaw] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): SyncSaw = {
    require (arity == 3)
    val _rate     = in.readRate()
...
object K2A extends ProductReader[K2A] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): K2A = {
    require (arity == 1)
    val _in = in.readGE()
    new K2A(_in)
  }
...
object A2K extends ProductReader[A2K] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): A2K = {
    require (arity == 1)
    val _in = in.readGE()
    new A2K(_in)
  }
...
object T2K extends ProductReader[T2K] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): T2K = {
    require (arity == 1)
    val _in = in.readGE()
    new T2K(_in)
  }
...
object T2A extends ProductReader[T2A] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): T2A = {
    require (arity == 1)
    val _in = in.readGE()
    new T2A(_in)
  }
...
object DC extends ProductReader[DC] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): DC = {
    require (arity == 2)
    val _rate = in.readRate()
    val _in   = in.readGE()
    new DC(_rate, _in)
...
object Line extends ProductReader[Line] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Line = {
    require (arity == 5)
    val _rate       = in.readRate()
...
object XLine extends ProductReader[XLine] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): XLine = {
    require (arity == 5)
    val _rate       = in.readRate()
    val _start      = in.readGE()
    val _end        = in.readGE()
...
object Wrap extends ProductReader[Wrap] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Wrap = {
    require (arity == 4)
    val _rate = in.readRate()
    val _in   = in.readGE()
    val _lo   = in.readGE()
...
object Fold extends ProductReader[Fold] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Fold = {
    require (arity == 4)
    val _rate = in.readRate()
    val _in   = in.readGE()
    val _lo   = in.readGE()
...
object Clip extends ProductReader[Clip] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Clip = {
    require (arity == 4)
    val _rate = in.readRate()
    val _in   = in.readGE()
    val _lo   = in.readGE()
...
object AmpComp extends ProductReader[AmpComp] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): AmpComp = {
    require (arity == 4)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
    val _root   = in.readGE()
...
object AmpCompA extends ProductReader[AmpCompA] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): AmpCompA = {
    require (arity == 5)
    val _rate     = in.readRate()
    val _freq     = in.readGE()
    val _root     = in.readGE()
...
object InRange extends ProductReader[InRange] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): InRange = {
    require (arity == 4)
    val _rate = in.readRate()
    val _in   = in.readGE()
    val _lo   = in.readGE()
...
object InRect extends ProductReader[InRect] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): InRect = {
    require (arity == 7)
    val _rate   = in.readRate()
    val _x      = in.readGE()
    val _y      = in.readGE()
...
object LinExp extends ProductReader[LinExp] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): LinExp = {
    require (arity == 6)
...
object EnvGen extends ProductReader[EnvGen] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): EnvGen = {
    require (arity == 7)
    val _rate       = in.readRate()
...
object Linen extends ProductReader[Linen] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Linen = {
    require (arity == 6)
    val _rate       = in.readRate()
    val _gate       = in.readGE()
...
object IEnvGen extends ProductReader[IEnvGen] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): IEnvGen = {
    require (arity == 3)
    val _rate     = in.readRate()
    val _envelope = in.readGE()
