...
object DegreeToKey extends ProductReader[DegreeToKey] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): DegreeToKey = {
    require (arity == 4)
    val _rate   = in.readRate()
    val _buf    = in.readGE()
    val _in     = in.readGE()
    val _octave = in.readGE()
...
object Select extends ProductReader[Select] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Select = {
    require (arity == 3)
    val _rate   = in.readRate()
...
object TWindex extends ProductReader[TWindex] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): TWindex = {
    require (arity == 4)
    val _rate       = in.readRate()
    val _trig       = in.readGE()
    val _prob       = in.readGE()
...
object Index extends ProductReader[Index] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Index = {
    require (arity == 3)
    val _rate = in.readRate()
    val _buf  = in.readGE()
    val _in   = in.readGE()
...
object IndexL extends ProductReader[IndexL] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): IndexL = {
    require (arity == 3)
    val _rate = in.readRate()
    val _buf  = in.readGE()
    val _in   = in.readGE()
...
object FoldIndex extends ProductReader[FoldIndex] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): FoldIndex = {
    require (arity == 3)
    val _rate = in.readRate()
    val _buf  = in.readGE()
    val _in   = in.readGE()
...
object WrapIndex extends ProductReader[WrapIndex] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): WrapIndex = {
    require (arity == 3)
    val _rate = in.readRate()
    val _buf  = in.readGE()
    val _in   = in.readGE()
...
object IndexInBetween extends ProductReader[IndexInBetween] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): IndexInBetween = {
    require (arity == 3)
    val _rate = in.readRate()
    val _buf  = in.readGE()
    val _in   = in.readGE()
...
object DetectIndex extends ProductReader[DetectIndex] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): DetectIndex = {
    require (arity == 3)
    val _rate = in.readRate()
    val _buf  = in.readGE()
    val _in   = in.readGE()
...
object Shaper extends ProductReader[Shaper] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Shaper = {
    require (arity == 3)
    val _rate = in.readRate()
    val _buf  = in.readGE()
    val _in   = in.readGE()
...
object FSinOsc extends ProductReader[FSinOsc] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): FSinOsc = {
    require (arity == 3)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
...
object SinOsc extends ProductReader[SinOsc] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): SinOsc = {
    require (arity == 3)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
...
object SinOscFB extends ProductReader[SinOscFB] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): SinOscFB = {
    require (arity == 3)
    val _rate     = in.readRate()
    val _freq     = in.readGE()
...
object VOsc extends ProductReader[VOsc] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): VOsc = {
    require (arity == 4)
    val _rate   = in.readRate()
    val _bufPos = in.readGE()
    val _freq   = in.readGE()
    val _phase  = in.readGE()
...
object VOsc3 extends ProductReader[VOsc3] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): VOsc3 = {
    require (arity == 5)
    val _rate   = in.readRate()
    val _bufPos = in.readGE()
    val _freq1  = in.readGE()
    val _freq2  = in.readGE()
    val _freq3  = in.readGE()
...
object Osc extends ProductReader[Osc] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Osc = {
    require (arity == 4)
    val _rate   = in.readRate()
    val _buf    = in.readGE()
    val _freq   = in.readGE()
...
object OscN extends ProductReader[OscN] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): OscN = {
    require (arity == 4)
    val _rate   = in.readRate()
    val _buf    = in.readGE()
    val _freq   = in.readGE()
...
object COsc extends ProductReader[COsc] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): COsc = {
    require (arity == 4)
    val _rate   = in.readRate()
    val _buf    = in.readGE()
    val _freq   = in.readGE()
    val _beats  = in.readGE()
...
object Formant extends ProductReader[Formant] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Formant = {
    require (arity == 4)
    val _rate     = in.readRate()
    val _fundFreq = in.readGE()
    val _formFreq = in.readGE()
    val _bw       = in.readGE()
...
object Blip extends ProductReader[Blip] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Blip = {
    require (arity == 3)
    val _rate     = in.readRate()
    val _freq     = in.readGE()
    val _numHarm  = in.readGE()
...
object Saw extends ProductReader[Saw] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Saw = {
    require (arity == 2)
    val _rate = in.readRate()
    val _freq = in.readGE()
    new Saw(_rate, _freq)
...
object Pulse extends ProductReader[Pulse] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Pulse = {
    require (arity == 3)
    val _rate   = in.readRate()
    val _freq   = in.readGE()
...
object Klang extends ProductReader[Klang] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Klang = {
    require (arity == 3)
    val _specs      = in.readGE()
    val _freqScale  = in.readGE()
    val _freqOffset = in.readGE()
...
object Klank extends ProductReader[Klank] {
  ...
  def read(in: RefMapIn, prefix: String, arity: Int): Klank = {
    require (arity == 5)
    val _specs      = in.readGE()
    val _in         = in.readGE()
    val _freqScale  = in.readGE()
    val _freqOffset = in.readGE()
    val _decayScale = in.readGE()
